...
const Navbar = () => {
  return (
    <div className='p-5 flex justify-between items-center'>
        <h1 className='font-adora text-5xl font-semibold'>shopflo travel</h1>
        <ul className='hidden md:flex space-x-8'>
            ...
            <li className='hover:border-b border-green-500'>Connect Us</li>
        </ul>
        <div className='flex items-center space-x-5'>
            <button className='px-5 py-2 rounded bg-gray-200'>Login</button>
